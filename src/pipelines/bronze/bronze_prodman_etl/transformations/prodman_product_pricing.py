"""Bronze: raw product pricing as landed in the Internal Drop zone by Product Management (see
...
@dp.table(
    ...
    comment="Raw product pricing exactly as landed in the Internal Drop volume by Product Management. No validation performed.",
